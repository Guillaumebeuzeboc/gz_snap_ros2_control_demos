...
def generate_launch_description():
    ...
    gz_snap_ros2_control_demos_path = os.path.join(
        get_package_share_directory('gz_snap_ros2_control_demos'))

    xacro_file = os.path.join(gz_snap_ros2_control_demos_path,
                              'urdf',
